...
// Queen is a subclass that inherits from the super-class Bee

public class Queen extends Bee {
    // Queen will inherit health and state from bee class
    ...
    public void Damage(int value) {
        ...
        // As the Queen is pronounced to be dead below 20, the state of the queen will now be declared dead (false --> no longer alive)

        else if(super.getHealth() < 20) {
            // printing this to see the if the dead value shows up on the console.

            System.out.println("Dead");
            // as it is below 20, the specific queen bee is no longer alive
